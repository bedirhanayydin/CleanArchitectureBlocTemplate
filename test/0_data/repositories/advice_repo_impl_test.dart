...
import 'package:performx/0_data/exceptions/exceptions.dart';
import 'package:performx/0_data/models/advice_model.dart';
import 'package:performx/0_data/repositories/advice_repo_impl.dart';
import 'package:performx/1_domain/entities/advice_entity.dart';
import 'package:performx/1_domain/failures/failures.dart';
  ...
  group('AdviceRepoImpl', () {
    group('should return AdviceEntitiy', () {
      test('when AdviceRemoteDatasource returns a AdviceModel', () async {
        ...
        when(mockAdviceRemoteDatasource.getAdvice())
        ...
        verify(mockAdviceRemoteDatasource.getAdvice()).called(1);
    ...
    group('should retrun left with', () {
      test('a ServerFailure when a ServerException occurs', () async {
        ...
        when(mockAdviceRemoteDatasource.getAdvice()).thenThrow(ServerException());
